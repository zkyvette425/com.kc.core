...
<root>
  ...
  ├── Editor
  │   ├── Meazza.ComKcCore.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Meazza.ComKcCore.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Meazza.ComKcCore.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Meazza.ComKcCore.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Meazza.ComKcCore`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package com.kc.core Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Meazza.ComKcCore.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Meazza.ComKcCore.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Meazza.ComKcCore.Editor.Tests.asmdef`

  `Tests/Runtime/Meazza.ComKcCore.Tests.asmdef`
...
Use the `Documentations~/com.kc.core.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
